...
ENV_CONTEXT="${HCLOUD_TOKEN@A} ${QDRANT_CLUSTER_URL@A} ${QDRANT_API_KEY@A} ${POSTGRES_HOST@A} ${POSTGRES_PASSWORD@A} ${QDRANT_HOSTS[@]@A} ${QC_NAME@A} ${QDRANT_PYTHON_CLIENT_VERSION@A}" \
